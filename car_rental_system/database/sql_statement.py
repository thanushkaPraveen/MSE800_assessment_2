...
SELECT_ALL_CARS_WITH_DETAILS = "SELECT Car.car_Id, Car.number_plate, Car.model_name, Car.daily_rate, Car.year, Car.mileage, Car.min_rental_period, Car.max_rental_period, Car.is_active AS car_is_active, Car.create_at AS car_created_at, Car.updated_at AS car_updated_at, CarBrandModel.brand_name, CarBrandModel.model_name AS brand_model_name, CarType.car_type, CarStatus.car_status_type FROM Car INNER JOIN CarBrandModel ON Car.car_brand_model_id = CarBrandModel.car_brand_model_id INNER JOIN CarType ON CarBrandModel.car_type_id = CarType.car_type_id INNER JOIN CarStatus ON Car.car_status_Id = CarStatus.car_status_Id"
SELECT_AVAILABLE_CARS_WITH_DETAILS = "SELECT Car.car_Id, Car.number_plate, Car.model_name, Car.daily_rate, Car.year, Car.mileage, Car.min_rental_period, Car.max_rental_period, Car.is_active AS car_is_active, Car.create_at AS car_created_at, Car.updated_at AS car_updated_at, CarBrandModel.brand_name, CarBrandModel.model_name AS brand_model_name, CarType.car_type, CarStatus.car_status_type FROM Car INNER JOIN CarBrandModel ON Car.car_brand_model_id = CarBrandModel.car_brand_model_id INNER JOIN CarType ON CarBrandModel.car_type_id = CarType.car_type_id INNER JOIN CarStatus ON Car.car_status_Id = CarStatus.car_status_Id WHERE Car.car_status_Id = 1"
SELECT_UNAVAILABLE_CARS_WITH_DETAILS = "SELECT Car.car_Id, Car.number_plate, Car.model_name, Car.daily_rate, Car.year, Car.mileage, Car.min_rental_period, Car.max_rental_period, Car.is_active AS car_is_active, Car.create_at AS car_created_at, Car.updated_at AS car_updated_at, CarBrandModel.brand_name, CarBrandModel.model_name AS brand_model_name, CarType.car_type, CarStatus.car_status_type FROM Car INNER JOIN CarBrandModel ON Car.car_brand_model_id = CarBrandModel.car_brand_model_id INNER JOIN CarType ON CarBrandModel.car_type_id = CarType.car_type_id INNER JOIN CarStatus ON Car.car_status_Id = CarStatus.car_status_Id WHERE Car.car_status_Id = 2"
